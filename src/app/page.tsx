          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="relative hidden lg:block perspective-[2000px]">
              ...
              <div className="relative transform rotate-y-[-10deg] rotate-x-[10deg] transition-transform duration-500 hover:rotate-0">
                ...
                <div className="absolute -top-8 -right-8 glass-card p-4 rounded-xl border-cyan-primary-200/60 shadow-xl animate-float bg-white/90 max-w-xs" style={{ animationDelay: '2.5s' }}>
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                      <span className="text-xs font-semibold text-slate-700 uppercase tracking-wider">Contract</span>
                    </div>
                    <span className="text-xs text-slate-500 font-mono">SOL</span>
                  </div>
                  <div className="space-y-2">
                    <code className="block text-xs font-mono text-slate-800 bg-slate-50 px-2 py-1 rounded border border-slate-200 select-all break-all">
                      DDLgZscBViQ4BMzdT53X8tHLZvHASZposb3Lh1xSpump
                    </code>
                    <button
                      className="w-full flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg bg-cyan-primary-600 hover:bg-cyan-primary-700 text-white text-xs font-medium transition-colors"
                      onClick={() => {
                        navigator.clipboard.writeText('7BgBvyjrZX1YKz4oh9mjb8ZScatkkwb8DzFx4LZHqCk');
                      }}
                    >
