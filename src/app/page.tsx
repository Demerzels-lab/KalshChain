        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
              ...
              <div className="mt-8 glass-card p-6 rounded-2xl border-cyan-primary-200/60 shadow-xl bg-white/90 max-w-sm">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                    <span className="text-sm font-semibold text-slate-700 uppercase tracking-wider">Contract Address</span>
                  </div>
                  <span className="text-xs text-slate-500 font-mono">SOLANA</span>
                </div>
                <div className="space-y-3">
                  <code className="block text-sm font-mono text-slate-800 bg-slate-50 px-3 py-2 rounded-lg border border-slate-200 select-all break-all">
                    DDLgZscBViQ4BMzdT53X8tHLZvHASZposb3Lh1xSpump
                  </code>
                  <button
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-cyan-primary-600 hover:bg-cyan-primary-700 text-white text-sm font-medium transition-colors"
                    onClick={() => {
                      navigator.clipboard.writeText('DDLgZscBViQ4BMzdT53X8tHLZvHASZposb3Lh1xSpump');
                    }}
                  >
